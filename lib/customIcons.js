...
export function CloudUploadIcon(props) {
  return (
    <svg
      ...
      height="24"
      viewBox="0 0 24 24"
      fill={props.none || 'none'}
      stroke={props.currentColor || 'currentColor'}
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    >
  ...
  export function HeartIcon(props) {
    return (
      <svg
        ...
        viewBox="0 0 24 24"
        fill={props.fill || "rgb(239 68 68)"}
        stroke={props.stroke || "rgb(239 68 68)"}
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      >
...
export function HeartCrackIcon(props) {
    return (
      <svg
        {...props}
        xmlns="http://www.w3.org/2000/svg"
